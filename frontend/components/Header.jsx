...
export default function Header({ className = "" }) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 h-4 z-40" onMouseEnter={() => setIsHeaderVisible(true)} />

      {/* Header */}
      <div
        className="fixed top-0 left-0 right-0 z-50"
        onMouseEnter={() => setIsHeaderVisible(true)}
        onMouseLeave={() => !isMobileMenuOpen && setIsHeaderVisible(false)}
      >
        <header
          className={`bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 ease-in-out ${
